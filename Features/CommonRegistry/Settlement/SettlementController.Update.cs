...
namespace UserManagement.Features.CommonRegistry.Settlement
{
    public partial class SettlementController : Controller
    {
        ...
        [ChildAction("CommonRegistry.Settlement.Update", "Settlement - Update", "Vendbanimi - Azhurim", "Prebivaliste - Ažuriranje")]
        [HttpGet]
        ...
        [ChildAction("CommonRegistry.Settlement.Update", "Settlement - Update", "Vendbanimi - Azhurim", "Prebivaliste - Ažuriranje")]
        [HttpPost]
        public async Task<IActionResult> Update(SettlementModel model)
        {
            SetupModel(model, CrudOp.Update);
