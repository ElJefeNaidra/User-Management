...
{
    public partial class MunicipalityModel : BaseCrudModel
    {
        ...
        #region IdRegion
        [Required(ErrorMessageResourceName = "ValidationRequired", ErrorMessageResourceType = typeof(_Resources.Common))]
        [DbDisplayName("IdRegion")]
        public int IdRegion { get; set; }

        public GenericGetDdlDataCollection IdRegionDdl
        {
            get
            {
                var obj = GenericGetDdlData.GetDdl("[CommonRegistry].[Region]", "IdRegion", "");
                return obj;
            }
        }
        #endregion
        ...
        public string display_IdRegion { get; set; } = "";
        ...
        public bool disable_IdRegion { get; set; } = false;
