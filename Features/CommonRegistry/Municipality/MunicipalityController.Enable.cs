...
namespace SIDPSF.Features.CommonRegistry.Municipality
{
    public partial class MunicipalityController : Controller
    {
        ...
        [ChildAction("CommonRegistry.Municipality.Enable", "Municipality - Enable", "Komuna - Aktivizim", "Opstina - Aktiviranje")]
        [HttpGet]
        ...
        [ChildAction("CommonRegistry.Municipality.Enable", "Municipality - Enable", "Komuna - Aktivizim", "Opstina - Aktiviranje")]
        [HttpPost]
        public async Task<IActionResult> Enable(MunicipalityModel model)
        {
            SetupModel(model, CrudOp.Enable);
