...
namespace SIDPSF.Features.CommonRegistry.Country
{
    public partial class CountryController : Controller
    {
        ...
        [ChildAction("Nomenclatures.Country.Disable", "Country - Disable", "Shteti - Deaktivizim", "Drzava - Deaktiviranje")]
        [HttpGet]
        ...
        [ChildAction("Nomenclatures.Country.Disable", "Country - Disable", "Shteti - Deaktivizim", "Drzava - Deaktiviranje")]
        [HttpPost]
        public async Task<IActionResult> Disable(CountryModel model)
        {
            SetupModel(model, CrudOp.Disable);
