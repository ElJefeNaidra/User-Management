...
namespace SIDPSF.Features.CommonRegistry.Language
{
    public partial class LanguageController : Controller
    {
        ...
        [ChildAction("CommonRegistry.Language.Enable", "Language - Enable", "Gjuha - Aktivizim", "Jezik - Aktiviranje")]
        [HttpGet]
        ...
        [ChildAction("CommonRegistry.Language.Enable", "Language - Enable", "Gjuha - Aktivizim", "Jezik - Aktiviranje")]
        [HttpPost]
        public async Task<IActionResult> Enable(LanguageModel model)
        {
            SetupModel(model, CrudOp.Enable);
