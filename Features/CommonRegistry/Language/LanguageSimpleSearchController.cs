...
namespace UserManagement.Features.CommonRegistry.Language
{
    ...
    public partial class LanguageSimpleSearchController : Controller
    {
        private const string SchemaName = "CommonRegistry";
        private const string TableName = "Language";
        ...
        public LanguageSimpleSearchController(DBContext dbContext, ResourceRepository ResourceRepo)
        {
            _ResourceRepo = ResourceRepo;
            _dbContext = dbContext;
        }

        [ChildAction("CommonRegistry.Language.GetView", "Language", "Gjuha", "Jezik")]
        [IsMenuItem]
        ...
        public async Task<IActionResult> GetView()
        {
            ...
            string TableNameDisplay = FormTranslationHelper.TableNameDisplay("Language");

            LanguageSimpleSearchModel model = new LanguageSimpleSearchModel();
            ...
            var (Data, TotalRows) = await _dbContext.GridDataAsync("[CommonRegistry].[USP_Language_Grid_Simple]", filterParameters);
