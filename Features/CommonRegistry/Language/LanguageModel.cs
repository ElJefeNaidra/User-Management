...
{
    public partial class LanguageModel : BaseCrudModel
    {

        #region IdLanguageId
        [HiddenInput]
        public int IdLanguageId { get; set; }
        #endregion
        ...
        public string display_IdLanguage { get; set; } = "";
        ...
        public bool disable_IdLanguage { get; set; } = false;
