...
namespace UserManagement.Features.Administration.User
{
    ...
    {
        #region HISTORY
        private async Task GetHistoryGrid(int Id, UserModel model)
        {
        ...
        [ChildAction("Administration.User.ReadHistory", "User - History", "Përdoruesi - Historiku", "Korisnik - Istorija")]
        [HttpGet]
